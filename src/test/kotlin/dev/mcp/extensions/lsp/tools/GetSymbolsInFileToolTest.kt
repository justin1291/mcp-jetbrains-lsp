...
class GetSymbolsInFileToolTest : JavaBaseTest() {
    ...
    fun testSymbolTypeFiltering() {
        ...
        assertTrue(methods.all { it.kind.value == "method" || it.kind.value == "constructor" }, 
    ...
    fun testEmptyFileHandling() {
        ...
        if (response.error == null) {
            ...
            assertTrue(symbols.isEmpty() || symbols.all { it.kind == SymbolKind.Import || it.kind == SymbolKind.Package },
    ...
    fun testNewMetadataFields() {
        ...
        assertEquals("java.lang.Object", equalsMethod.overrides?.parentClass, 
            "equals should override Object.equals")
        assertEquals("equals", equalsMethod.overrides?.methodName)
        
        assertEquals("java.lang.Object", hashCodeMethod.overrides?.parentClass, 
        ...
        assertEquals(Visibility.PACKAGE, baseEntityClass.visibility, 
    ...
    fun testHierarchicalMetadataFields() {
        ...
        assertTrue(mainClass.decorators?.isNotEmpty() == true, 
        ...
        val userListenerInterface = mainClass.children?.find { it.name == "UserListener" && it.kind == SymbolKind.Interface }
        ...
        assertEquals(Visibility.PACKAGE, packagePrivateMethod.visibility, 
