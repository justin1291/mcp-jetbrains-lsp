...
class GetHoverInfoToolTestJava : JavaBaseTest() {
    ...
    private val tool: GetHoverInfoTool = GetHoverInfoTool()
    ...
    fun testHoverOnConstructor() {
        ...
        assertTrue(
            hoverInfo.signature?.contains("String id, String name, String email") ?: false,
    ...
    fun testHoverOnInterface() {
        ...
        assertTrue(
            hoverInfo.modifiers.contains("@FunctionalInterface") ||
    ...
    fun testHoverOnImport() {
        ...
        if (hoverInfo.elementName != null) {
            assertTrue(
                hoverInfo.elementType == "class" || hoverInfo.elementType == "import",
    ...
    fun testHoverWithInvalidPosition() {
        ...
        if (response.error != null) {
            assertTrue(
                response.error!!.contains("position") ||
    ...
    fun testEnhancedClassHoverInfo() {
        ...
        assertEquals("User", hoverInfo.elementName, "Should identify User class")
        assertTrue(
            hoverInfo.superTypes.isNotEmpty() || true,
    ...
    fun testDeprecatedElements() {
        ...
        assertTrue(
            hoverInfo.deprecationMessage?.contains("Use dynamic limits") ?: false,
